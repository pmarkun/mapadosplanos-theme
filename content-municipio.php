	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="tab-content">
			...
			<div class="tab-pane" id="parte2">
				...
				<p>Se você é gestor, colabore conosco nesta coleta de informações e <a href="<?php bloginfo('wpurl');?>/wp-admin/edit.php?p=<?php the_ID(); ?>">preencha o questionário</a> sobre a elaboração do Plano de Educação do seu Município. </p>
